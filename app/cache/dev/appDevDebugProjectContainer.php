...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pointweb.twig.app_extension' => 'getPointweb_Twig_AppExtensionService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mediashaskadmin.mysql.db', 'port' => NULL, 'dbname' => 'mediashaskadmin', 'user' => 'mediashaskadmin', 'password' => 'Timquand1', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2b2bb4bad71730c522106d91cc725a3885b953d6cf2b4ad4cf23332e32817535');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('PointWeb\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('PointWeb\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('PointWeb\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('PointWeb\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'PointWeb\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'my_thumb_1_1' => array('quality' => 80, 'filters' => array('thumbnail' => array('size' => array(0 => 161, 1 => 127), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'my_thumb_1_2' => array('quality' => 120, 'filters' => array('thumbnail' => array('size' => array(0 => 161, 1 => 127), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'my_thumb_1_3' => array('quality' => 180, 'filters' => array('thumbnail' => array('size' => array(0 => 362, 1 => 321), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    /**
     * Gets the 'pointweb.twig.app_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PointWeb\AppBundle\Twig\AppExtension A PointWeb\AppBundle\Twig\AppExtension instance.
     */
    protected function getPointweb_Twig_AppExtensionService()
    {
        return $this->services['pointweb.twig.app_extension'] = new \PointWeb\AppBundle\Twig\AppExtension($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('mediashaskadmin.mysql.db');
        $instance->setPort(25);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/PointWeb/AppBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'charset' => 'UTF-8', 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'PointWebAdminBundle:Form:fields.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'PointWebAdminBundle:Form:fields.html.twig', 2 => 'LiipImagineBundle:Form:form_div_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        ...
        $instance->addExtension($this->get('pointweb.twig.app_extension'));
        ...
        $instance->addGlobal('base', 'http://mediashare.fr/web/');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PointWeb/AppBundle/Resources/views'), 'PointWebApp');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PointWeb/NewsletterBundle/Resources/views'), 'PointWebNewsletter');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PointWebAppBundle' => 'PointWeb\\AppBundle\\PointWebAppBundle',
                ...
                'PointWebNewsletterBundle' => 'PointWeb\\NewsletterBundle\\PointWebNewsletterBundle',
            ...
            'database_host' => 'mediashaskadmin.mysql.db',
            'database_port' => NULL,
            'database_name' => 'mediashaskadmin',
            'database_user' => 'mediashaskadmin',
            'database_password' => 'Timquand1',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mediashaskadmin.mysql.db',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'mail_to' => 'marquand.thibault@gmail.com',
            'base' => 'http://mediashare.fr/web/',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'PointWebAdminBundle:Form:fields.html.twig',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mediashaskadmin.mysql.db',
            ...
            'fos_user.model.user.class' => 'PointWeb\\UserBundle\\Entity\\User',
