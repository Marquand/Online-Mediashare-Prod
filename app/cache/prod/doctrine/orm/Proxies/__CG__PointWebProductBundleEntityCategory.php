...
class Category extends \PointWeb\ProductBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'childrens', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'parent', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'position', 'pictures', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'online'];
        }

        return ['__isInitialized__', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'childrens', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'parent', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'position', '' . "\0" . 'PointWeb\\ProductBundle\\Entity\\Category' . "\0" . 'online'];
    }
